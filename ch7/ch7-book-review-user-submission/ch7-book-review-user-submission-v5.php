...
function ch7_brus_book_review_form() { 
	...
	<form method="post" id="add_book_review" action="">
		...
		<table><tr>
			...
			<td><img id="captcha" src="<?php echo plugins_url( 'securimage/securimage_show.php', __FILE__ ); ?>" alt="CAPTCHA Image" />
			<input type="text" name="captcha_code" size="10" maxlength="6" />
			<a href="#" onclick="document.getElementById( 'captcha' ).src = '<?php echo plugins_url( '/securimage/securimage_show.php', __FILE__ ); ?>?' + Math.random(); return false">[ New Image ]</a>
			</td>
		</tr></table>
